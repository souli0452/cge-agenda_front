...
<div class="corbeille-page">
    ...
    styles: [`
        ...
        .empty-state i { font-size: 64px; color: #4caf50; margin-bottom: 16px; display: block; }
        .empty-state h4 { font-size: 20px; font-weight: 700; margin-bottom: 8px; }
